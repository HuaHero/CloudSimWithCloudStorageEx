...
//	protected <T extends Cloudlet> void setCloudletList(List<T> cloudletList) {
		...
		for(int i=1;i<cloudletNum;i++){
			...
			for(int j=vmNum-2;j>=0;j--){
				...
				//简单的负载均衡
					...
					System.out.print(i + "th" + "vmLoad[" + idx + "]="
							+ vmLoad[idx] + "minLoad=" + minLoad);
					System.out.println();
				}
			}
		}
	...
	private class CloudletComparator implements Comparator<Cloudlet>{
		...
		public int compare(Cloudlet arg0, Cloudlet arg1) {
			// TODO Auto-generated method stub
			return (int)(arg1.getCloudletLength()-arg0.getCloudletLength());
		}
	}
